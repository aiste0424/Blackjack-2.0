...
public:
	...
	void Win(Player* player, Dealer* dealer, Score score, Cash cash, Doubles doubles);   //I needed to inherit player, dealer and score as factors of the outcome
	void Lose(Player* player, Dealer* dealer, Score score, Cash cash, Doubles doubles);
